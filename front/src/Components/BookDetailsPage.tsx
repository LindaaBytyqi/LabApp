...
//     setPopupMessage(`You added "${book.title}" to the cart!`);
//     setShowPopup(true);

// // Mbyll automatikisht pas 2 sekondash
...
//   >
//     <Modal.Content>
//       <p style={{ textAlign: "center", color: "white" }}>{popupMessage}</p>
//     </Modal.Content>
//   </Modal>
// </> );
//  }
...
export default function BookDetailsPage() {
  ...
  const handleAddToCart = () => {
    ...
    // Mbyll popup dhe navigo pas 2 sekondash
    setTimeout(() => {
      setShowPopup(false);
      navigate("/cart");
    }, 2000);
  ...
  return (
    <>
     ...
     position: "fixed",
    top: "20px",           // vendoset lart
    left: "50%",           // qendruar horizontalisht
    transform: "translateX(-50%)",
    backgroundColor: "#b5b7aeff", // ngjyrë e verdhë pastel
    color: "#050404ff",
    padding: "15px 25px",
    borderRadius: "8px",
    zIndex: 1000,
